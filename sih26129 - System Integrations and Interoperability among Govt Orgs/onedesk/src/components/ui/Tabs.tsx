...
export function TabsTrigger({ className, ...props }: TabsPrimitive.TabsTriggerProps) {
  return (
    <TabsPrimitive.Trigger
      className={cn(
        'rounded-sm px-3 py-1.5 text-sm font-medium text-gray-500 transition-colors',
        'data-[state=active]:bg-white data-[state=active]:text-navy-800 data-[state=active]:shadow-xs',
        className,
      )}
      {...props}
    />
